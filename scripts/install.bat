...
REM
REM Lives beside the wrappers that call it, but .venv belongs to the repository
REM rather than to scripts\, so this runs from the root like every other wrapper.
setlocal
cd /d "%~dp0.."
